...
<div id="sidebar" class="w-[20%] h-screen bg-gray-100 shadow-md fixed p-4 transition-all duration-300 ease-in-out">
    ...
    <ul class="space-y-4">
        <li>
            <a href="#" class="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md">
                ...
                <span class="ml-3 sidebar-text" id="sidebar-text">Dashboard</span>
            </a>
        </li>
        ...
        <li>
            <a href="#" class="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md">
                ...
                <span class="ml-3 sidebar-text" id="sidebar-text">Product</span>
            </a>
        </li>                      
        ...
        <li>
            <a href="#" class="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md">
                ...
                <span class="ml-3 sidebar-text" id="sidebar-text">Inbox</span>
            </a>
        </li>
        ...
        <li>
            <a href="#" class="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md">
                ...
                <span class="ml-3 sidebar-text" id="sidebar-text">Order Lists</span>
            </a>
        </li>
        ...
        <li>
            <a href="#" class="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md">
                ...
                <span class="ml-3 sidebar-text" id="sidebar-text">Product Stocks</span>
            </a>
        </li>
        ...
        <li>
            <a href="#" class="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24">
                    ...
                    <span class="ml-3 sidebar-text" id="sidebar-text">Invoice</span>
            </a>
        </li>              
    ...
    <li>
            <a href="#" class="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md">
                ...
                <span class="ml-3 sidebar-text" id="sidebar-text">Customer</span>
            </a>
        </li>
        ...
        <li>
            <a href="#" class="flex items-center p-2 text-gray-700 hover:bg-gray-100 rounded-md">
                ...
                <span class="ml-3 sidebar-text" id="sidebar-text">General Setting</span>
            </a>
        </li>
